...
This resource is good for [learning markdown](https://www.markdownguide.org/basic-syntax) for any READMEs.

## Kicad Instructions

1. Use the [Archive 3D Models Plugin](https://github.com/MitjaNemec/Archive3DModels) for Kicad with the default path.
2. Make relative symlinks named Project-files and packages3D to Project-files and Models/Kicad respectively in your PCB project directory, it will keep all the symbols, footprint and 3D models in one place to make it easily transportable, example in PCBs/JLCPCB/Thumb-v1.
