...
This PCB is designed to offload all the processing to a 3.3V Promicro sized/pinout board, so we can work with a 2 layer board and we can replace the processing board with a better/more functioning one if we want to.__
